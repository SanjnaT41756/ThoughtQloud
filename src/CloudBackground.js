...
const CloudBackground = ({ numberOfClouds, type }) => {
  ...
  if (type == "initial"){
    ...
    bubbleTitles.push("My child has expressed interest in a non-normalized relationship")
  }
  else if (type == "queer"){
    ...
    header = "What are you thinking?"
    bubbleTitles.push("Everything that I thought for my child will no longer happen.")
    bubbleTitles.push("I don't want them to go through the hardships of being queer.")
  }
    ...
    header = "Queer is an umbrella term that includes a variety of sexual orientations and gender identities beyond the traditional categories of straight and cisgender."
